...
![Pipeline Governance](https://img.shields.io/badge/Pipeline-Governance-blue)
![Forecast Confidence](https://img.shields.io/badge/Forecast-Confidence-success)
![Coverage Analysis](https://img.shields.io/badge/Pipeline-Coverage-purple)
![Forecast Survivability](https://img.shields.io/badge/Forecast-Survivability-darkblue)
![Revenue Operations](https://img.shields.io/badge/Revenue-Operations-orange)
![Executive Analytics](https://img.shields.io/badge/Executive-Decision%20Support-black)
![Commercial Intelligence](https://img.shields.io/badge/Commercial-Intelligence-teal)
![Q3 Assessment](https://img.shields.io/badge/Q3-Year--End%20Assessment-critical)
...
flowchart TD
    ...
    A["<table><tr><td width='350' align='center'>Uncommitted</td></tr></table>"] --> B["<table><tr><td width='350' align='center'>Likely</td></tr></table>"]
    B --> C["<table><tr><td width='350' align='center'>Committed</td></tr></table>"]
    C --> D["<table><tr><td width='350' align='center'>Closed Revenue</td></tr></table>"]

    %% Individual Node Color Overrides (Matching your brand palette)
    ...
    style D fill:#084298,color:#ffffff,stroke:#084298,stroke-width:3px
```
