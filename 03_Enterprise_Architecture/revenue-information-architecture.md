...
![Forecast Governance](https://img.shields.io/badge/Forecast-Governance-orange)
![Decision Science](https://img.shields.io/badge/Decision-Science-purple)
![Enterprise Architecture](https://img.shields.io/badge/Enterprise-Architecture-black)
...
style G fill:#fff3cd,stroke:#997404,stroke-width:2px

style H fill:#f8d7da,stroke:#b02a37,stroke-width:2px

style I fill:#d1e7dd,stroke:#146c43,stroke-width:2px

style J fill:#e2d9f3,stroke:#6f42c1,stroke-width:2px
```
...
A --> B["Revenue Construction"]

B --> C["Revenue Realization"]

C --> D["Forecast Intelligence"]
