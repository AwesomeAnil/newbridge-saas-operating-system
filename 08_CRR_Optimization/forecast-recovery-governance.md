...
![CRR](https://img.shields.io/badge/Central%20Risk-Reserve-darkred)
![Forecast Recovery](https://img.shields.io/badge/Forecast-Recovery-critical)
![Solver Optimization](https://img.shields.io/badge/Solver-Optimization-success)
...
![Board Room](https://img.shields.io/badge/Board--Room-Commercial%20Governance-black)
![Predictive Analytics](https://img.shields.io/badge/Predictive-Recovery%20Modeling-teal)
...
A[Full Pipe Coverage<br>105.1%]
--> B[Qualified Pipe Coverage<br>92.5%]

B --> C[High-Confidence Coverage<br>78%]

C --> D[Enterprise Exposure]

D --> E[CRR Recovery Governance]
```
...
![Full Pipe](https://img.shields.io/badge/Full%20Pipe-Coverage%20105.1%25-blue?style=for-the-badge)

<p align="center">
  <img src="../assets/images/Full-Pipe.png"
       alt="Full Pipe Geography Coverage"
       width="75%">
</p>
...
B --> C[Enterprise Exposure]

C --> D[CRR Activation]

D --> E[Recovery Lever Optimization]

E --> F[Geographic Prioritization]

F --> G[Solver Optimization]

G --> H[Recovery Frontier]
```
